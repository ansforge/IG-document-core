...
**Group 1**Mapping from `https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/Responsable` to [CDA - legalAuthenticator](StructureDefinition-fr-core-legal-authenticator.md)
