...
**Group 1**Mapping from `https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/Consentement` to [CDA - authorization](StructureDefinition-fr-core-authorization.md)
...
**Group 2**Mapping from [CDA - authorization](StructureDefinition-fr-core-authorization.md) to [Consent Extension](http://hl7.org/fhir/uv/fhir-clinical-document/STU1/StructureDefinition-consent-extension.html)
