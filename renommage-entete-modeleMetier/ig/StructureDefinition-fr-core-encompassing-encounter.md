...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-encompassing-encounter | *Version*:0.1.0 |
| Draft as of 2025-10-20 | *Computable Name*:FrEncompassingEncounter |
...
* Use this Logical Model Profile: [CDA - componentOf](StructureDefinition-fr-core-component-of.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-core-encompassing-encounter)
...
Other representations of profile: [CSV](StructureDefinition-fr-core-encompassing-encounter.csv), [Excel](StructureDefinition-fr-core-encompassing-encounter.xlsx) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-encompassing-encounter",
  "version" : "0.1.0",
  "name" : "FrEncompassingEncounter",
        ...
        "type" : [
          {
            ...
            "profile" : [
              "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-encounter-participant"
            ]
          }
        ]
      },
        ...
        "type" : [
          {
            ...
            "profile" : [
              "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-health-care-facility"
            ]
          }
        ]
      }
