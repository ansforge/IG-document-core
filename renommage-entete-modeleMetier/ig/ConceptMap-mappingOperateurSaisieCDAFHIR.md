...
**Group 1**Mapping from `https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/OperateurSaisie` to [CDA - dataEnterer](StructureDefinition-fr-core-data-enterer.md)
