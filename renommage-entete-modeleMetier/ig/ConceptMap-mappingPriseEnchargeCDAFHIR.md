...
**Group 1**Mapping from `https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/PriseEncharge` to [CDA - componentOf](StructureDefinition-fr-core-component-of.md)
