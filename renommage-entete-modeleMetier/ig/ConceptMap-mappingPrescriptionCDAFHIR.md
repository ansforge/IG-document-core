...
**Group 1**Mapping from `https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/Prescription` to [CDA - inFulfillmentOf](StructureDefinition-fr-core-inFulfillment-of.md)
