...
**Group 1**Mapping from `https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/Informateur` to [CDA - informant](StructureDefinition-fr-core-informant.md)
