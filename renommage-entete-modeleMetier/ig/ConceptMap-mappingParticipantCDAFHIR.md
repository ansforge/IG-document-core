...
**Group 1**Mapping from `https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/Participant` to [CDA - participant](StructureDefinition-fr-core-participant.md)
