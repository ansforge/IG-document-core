...
**Group 1**Mapping from `https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/DestinatairePrevu` to [CDA - informationRecipient](StructureDefinition-fr-core-information-recipient.md)
