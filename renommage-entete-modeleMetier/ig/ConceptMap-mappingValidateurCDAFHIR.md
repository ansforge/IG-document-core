...
**Group 1**Mapping from `https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/Validateur` to [CDA - authenticator](StructureDefinition-fr-core-authenticator.md)
