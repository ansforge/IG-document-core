...
**Group 1**Mapping from `https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/EnteteDocument` to [CDA - clinicalDocument](StructureDefinition-fr-core-clinical-document.md)
