...
**Group 1**Mapping from `https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/PersonneStructure` to [CDA - relatedEntity](StructureDefinition-fr-core-related-entity.md)
