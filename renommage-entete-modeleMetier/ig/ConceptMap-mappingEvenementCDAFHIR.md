...
**Group 1**Mapping from `https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/Evenement` to [CDA - documentationOf](StructureDefinition-fr-core-documentation-of.md)
