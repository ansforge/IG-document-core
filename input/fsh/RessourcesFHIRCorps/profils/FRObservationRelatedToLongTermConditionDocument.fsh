Profile: FRObservationRelatedToLongTermConditionDocument
Parent: Observation
Id: fr-observation-related-to-long-term-condition-document
Title: "Observation - FR Observation Related To Long Term Condition Document"
Description: "FRObservationRelatedToLongTermConditionDocument permet d'indiquer si l'élément auquel elle est associée est en rapport avec une Affection Longue Durée (ALD)."
