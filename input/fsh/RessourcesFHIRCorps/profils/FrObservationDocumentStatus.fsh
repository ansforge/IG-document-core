// StructureDefinition for FrObservationDocumentStatus
Profile: FrObservationDocumentStatus
Parent: Observation
Id: fr-observation-document-status
Title: "Observation - Fr Document Status"
Description: "FrObservationDocumentStatus permet d'indiquer le statut du document (son état d'avancement dans le cycle de vie du document, 
depuis sa création jusqu'à sa validation définitive par son responsable légal ainsi que la date de ce statut."
