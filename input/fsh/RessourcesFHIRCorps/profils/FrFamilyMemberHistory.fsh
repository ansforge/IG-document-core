...
* condition.extension[author].extension[reference].valueReference only Reference(FrPractitionerRoleDocument or FrPatientINSDocument or FrDeviceDocument or FrPatientDocument)