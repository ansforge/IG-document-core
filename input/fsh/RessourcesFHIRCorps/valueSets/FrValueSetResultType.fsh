...
* include http://loinc.org#18748-4 "Imagerie"
* include http://loinc.org#26438-2 "Cytologie"
* include http://loinc.org#27898-6 "Pathologie"
* include http://loinc.org#26435-8 "Génétique humaine"
* ^experimental = false