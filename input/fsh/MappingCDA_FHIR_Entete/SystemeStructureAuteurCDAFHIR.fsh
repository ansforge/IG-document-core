...
* group[=].element[+].code = #Systeme.identificationAuteur							
* group[=].element[=].target.code = #assignedAuthor
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #Systeme.identificationAuteur.identifiantAuteur							
* group[=].element[=].target.code = #assignedAuthor.id
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #Systeme.identificationAuteur.professionSavoirFaireRole							
* group[=].element[=].target.code = #assignedAuthor.code
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #Systeme.identificationAuteur.systeme							
* group[=].element[=].target.code = #assignedAuthor.assignedAuthoringDevice
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #Systeme.identificationAuteur.systeme.nomModeleSysteme							
* group[=].element[=].target.code = #assignedAuthor.assignedAuthoringDevice.manufacturerModelName
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #Systeme.identificationAuteur.systeme.nomSysteme							
* group[=].element[=].target.code = #assignedAuthor.assignedAuthoringDevice.softwareName
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #Systeme.identificationAuteur.structure						
* group[=].element[=].target.code = #assignedAuthor.representedOrganization
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #Systeme.identificationAuteur.structure.identifiantStructure							
* group[=].element[=].target.code = #assignedAuthor.representedOrganization.id
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #Systeme.identificationAuteur.structure.nomStructure						
* group[=].element[=].target.code = #assignedAuthor.representedOrganization.name
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #Systeme.identificationAuteur.structure.adresse						
* group[=].element[=].target.code = #assignedAuthor.representedOrganization.addr
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #Systeme.identificationAuteur.structure.coordonneesTelecom						
