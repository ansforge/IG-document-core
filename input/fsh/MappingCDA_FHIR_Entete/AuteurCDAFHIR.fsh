...
Description: """Ce ConceptMap présente deux groupes de mapping : 
 ...
 - Groupe Mapping 2 : entre l'élément CDA author et l'élément FHIR Composition.author"""
...
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "L'élément auteurPersonneStructure est de type PersonneStructure."
* group[=].element[+].code = #Auteur.auteurSysteme								
* group[=].element[=].target.code = #author.assignedAuthor								
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "L'élément auteurSysteme est de type Systeme"
