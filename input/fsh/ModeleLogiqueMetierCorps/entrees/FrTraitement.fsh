...
* medicament 1..1 FrProduitSante "Médicament"
* reason 0..* FrReferenceInterne "Motif du traitement"
// MedicationAdministration.request
* prescription 0..* FrPrescriptionEntry "Prescription"
// MedicationAdministration.supportingInformation
* subordinateTreatment 0..* FrTraitementSubordonne "Traitement subordonné"
//MedicationAdministration.supportingInformation
* instructionsPatient 0..1 FrInstructionsPatient "Instruction au patient"
