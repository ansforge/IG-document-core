...
* participant 0..* FrParticipantCorps "Participant: Si différent de celui de l’entête"
//encounter
* circonstances 0..* FrRencontre "Circonstances ayant décidé de l’acte. Réference interne à une Rencontre"
//reasonReference
* reason 0..* FrReferenceInterne "Motif de l'acte"
//deviceUsed
* dispositifMedical  0..* FrDispositifMedicalEntry "Réference interne à un DispositifMedical"
// équivalent FHIR : reasonReference ?
* difficulte 0..1 FrObservation "Difficulté"
// équivalent FHIR : reasonReference ?
* scores 0..* FrObservation "Scores"