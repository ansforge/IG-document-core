Logical: EvenementsIndesirablesSuiteAdministrationDerivesSang
//Id: fr-evenements-indesirables-suite-administration-derives-sang
Title: "Evènements indésirables suite à l'administration de dérivés du sang"
Description: """Modèle logique métier de l'entrée Evènements indésirables suite à l'administration de dérivés du sang"""
