...
Title: "DICOM SOP Instance Observation"
Description: """Modèle logique métier de l'entrée DICOM SOP Instance Observation"""
...
* observation 0..* DICOMSOPInstanceObservationSubordonnee "DICOM-SOP-instance-observation-subordonnee"
* objectifsReferences 0..* DICOMObjectifsDeReference "DICOM-Objectifs-de-reference"
