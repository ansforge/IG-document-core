Logical: DispositifMedicalEntry
//Parent: EHDSDeviceUse
//Id: fr-dispositif-medical-entry
Title: "Dispositif médical"
Description: """Modèle logique métier de l'entrée Dispositif médical"""
...
* performer 0..* PersonneStructure "Dispensateur"
// Absent dans le modèle EHDSDeviceUse et pas d'équivalent en FHIR --> Peut être inclus comme extension ?
* auteur 0..* Auteur "Prescripteur"
// en FHIR et EHDS : 1..1
* dispositifMedical 1..* DispositifMedical "Dispositif médical"
