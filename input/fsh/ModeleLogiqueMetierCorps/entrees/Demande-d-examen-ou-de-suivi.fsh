Logical: DemandeExamenOuSuivi
//Parent: EHDSServiceRequest
//Id: fr-demande-examen-ou-suivi
Title: "Demande d'examen ou de suivi / Objectif à atteindre"
Description: """Modèle logique métier de l'entrée Demande d'examen ou de suivi / Objectif à atteindre"""
