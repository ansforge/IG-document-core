...
* auteur 0..* FRLMAuteur "Auteur: Si différent de celui de l’entête"
* informateur 0..* FRLMInformateur "Informateur: Si différent de celui de l’entête"
* participant 0..* FRLMParticipantCorps "Participant: Si différent de celui de l’entête"
//encounter
