...
//Id: fr-problem
Title: "Problème"
Description: """Modèle logique métier de l'entrée Problème"""
...
* statutProbleme 0..1 StatutProbleme "Statut du problème"
//severity
* severite 0..1 Severite "Sévérité"
//diagnosisAssertionStatus : CodeableConcept
* certitude 0..1 Certitude "Certitude"
// Absent du modèle EHDS / Pas d’équivalent FHIR
* statutClinique 0..1 StatutCliniquePatient "Statut clinique du patient" 
