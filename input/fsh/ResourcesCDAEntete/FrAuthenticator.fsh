...
* signatureCode ^short = "Signature"
* signatureCode.code ^short = "S pour 'signed'"
* signatureCode.sdtcValueSet 0..0
* signatureCode.sdtcValueSetVersion 0..0
* time ^short = "Date/heure de l'attestation de validité " 
* time.value ^short = "Date et heure à laquelle le PS atteste la validité des informations portées sur le document. Précisée à la seconde avec précision du décalage 
par rapport au temps universel (UTC)"
