...
* id ^short = "Identifiant de la prescription :
...
contenant l'autorité d'affectation et l'attribut @extension contenant l'identifiant géré par cette autorité."
* id.root 1..1
* id.root ^short = "OID"
* id.extension 0..1
...
* id.displayable 0..0
* extension[AccessionNumberExtension].extension[accessionNumber]
* code 0..0
* priorityCode 0..0