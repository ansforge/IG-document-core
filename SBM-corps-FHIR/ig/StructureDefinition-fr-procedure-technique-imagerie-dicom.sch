...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure">
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/procedure-method']) &gt;= 1">extension with URL = 'http://hl7.org/fhir/StructureDefinition/procedure-method': minimum cardinality of 'extension' is 1</sch:assert>
