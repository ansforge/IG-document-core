...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'dosage']) &gt;= 1">extension with URL = 'dosage': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'dosage']) &lt;= 1">extension with URL = 'dosage': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-repeat-number-extension']) &lt;= 1">extension with URL = 'https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-repeat-number-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'prescripteur']) &lt;= 1">extension with URL = 'prescripteur': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Extension/f:extension/f:value[x]/f:additionalInstruction 1</sch:title>
    <sch:rule context="f:Extension/f:extension/f:value[x]/f:additionalInstruction">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:text) &gt;= 1">text: minimum cardinality of 'text' is 1</sch:assert>
      <sch:assert test="count(f:text) &lt;= 1">text: maximum cardinality of 'text' is 1</sch:assert>
    </sch:rule>
  ...
  <sch:pattern>
    <sch:title>f:Extension/f:extension/f:value[x]/f:doseAndRate 1</sch:title>
    <sch:rule context="f:Extension/f:extension/f:value[x]/f:doseAndRate">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
