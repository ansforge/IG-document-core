...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-assigned-custodian | *Version*:0.1.0 |
| Draft as of 2025-10-13 | *Computable Name*:FrAssignedCustodian |
...
* Use this Logical Model Profile: [CDA - custodian](StructureDefinition-fr-core-custodian.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-core-assigned-custodian)
...
Other representations of profile: [CSV](StructureDefinition-fr-core-assigned-custodian.csv), [Excel](StructureDefinition-fr-core-assigned-custodian.xlsx) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-assigned-custodian",
  "version" : "0.1.0",
  "name" : "FrAssignedCustodian",
        ...
        "type" : [
          {
            ...
            "profile" : [
              "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-represented-custodian-organization"
            ]
          }
        ]
      }
