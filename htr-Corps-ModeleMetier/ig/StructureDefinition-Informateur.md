...
* Derived from this Logical Model: [Informant APSR](StructureDefinition-InformantAPSR.md)
* Use this Logical Model: [Modèle logique métier de l'en-tête](StructureDefinition-EnteteDocument.md), [Acte](StructureDefinition-FrActe.md), [Rencontre](StructureDefinition-FrRencontre.md) and [Statut fonctionnel](StructureDefinition-FrStatutFonctionnel.md)
