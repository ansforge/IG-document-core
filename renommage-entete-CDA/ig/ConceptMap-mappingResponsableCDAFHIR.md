...
| Draft as of 2025-10-20 | *Computable Name*:Mapping Métier/CDA/FHIR : "Responsable du document" |
...
**Group 1**Mapping from [Modèle métier - Responsable du document](StructureDefinition-Responsable.md) to `https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-legal-authenticator`
