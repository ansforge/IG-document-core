...
| Draft as of 2025-10-20 | *Computable Name*:Mapping Métier/CDA/FHIR : "Validateur" |
...
**Group 1**Mapping from [Modèle métier - Validateur du document](StructureDefinition-Validateur.md) to `https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-authenticator`
