...
| Draft as of 2025-12-15 | *Computable Name*:FRLMCertitude |
...
* Utiliser ce Modèle logique: [Modèle logique métier - FR LM Allergie ou Hypersensibilité](StructureDefinition-fr-lm-allergie-ou-hypersensibilite.md) and [Modèle logique métier - FR LM Problème](StructureDefinition-fr-lm-probleme.md)
