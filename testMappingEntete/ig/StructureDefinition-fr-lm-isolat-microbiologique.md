...
| Draft as of 2025-12-15 | *Computable Name*:FRLMIsolatMicrobiologique |
...
* Utiliser ce Modèle logique: [Modèle logique métier - FR LM Resultats d'examens de biologie medicale](StructureDefinition-fr-lm-resultats-examens-biologie-medicale.md)
