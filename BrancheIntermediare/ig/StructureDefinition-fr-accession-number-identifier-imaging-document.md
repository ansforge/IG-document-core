# FR Accession Number Identifier Imaging Document - ANS IG document core v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **FR Accession Number Identifier Imaging Document**

## Data Type Profile: FR Accession Number Identifier Imaging Document 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-accession-number-identifier-imaging-document)
...
Other representations of profile: [CSV](StructureDefinition-fr-accession-number-identifier-imaging-document.csv), [Excel](StructureDefinition-fr-accession-number-identifier-imaging-document.xlsx), [Schematron](StructureDefinition-fr-accession-number-identifier-imaging-document.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-accession-number-identifier-imaging-document",
  "version" : "0.1.0",
  ...
  "mapping" : [
    {
      "identity" : "DicomToAccessionNumber",
      "uri" : "http://nema.org/dicom",
      "name" : "Mapping from Accession Number Identifier to DICOM",
      "comment" : "Mapping from Accession Number Identifier to DICOM"
    },
    {
      "identity" : "v2",
      "uri" : "http://hl7.org/v2",
