...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:value[x]/f:coding/f:extension 1</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:value[x]/f:coding/f:extension/f:extension 1</sch:title>
    <sch:rule context="f:Observation/f:value[x]/f:coding/f:extension/f:extension">
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
