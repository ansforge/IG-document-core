...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-record-target | *Version*:0.1.0 |
| Draft as of 2025-10-13 | *Computable Name*:FrRecordTarget |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-core-record-target)
...
Other representations of profile: [CSV](StructureDefinition-fr-core-record-target.csv), [Excel](StructureDefinition-fr-core-record-target.xlsx) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-record-target",
  "version" : "0.1.0",
  "name" : "FrRecordTarget",
        ...
        "type" : [
          {
            ...
            "profile" : [
              "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-patient-role"
            ]
          }
        ]
      }
