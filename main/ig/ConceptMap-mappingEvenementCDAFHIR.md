...
| Draft as of 2025-10-20 | *Computable Name*:Mapping Métier/CDA/FHIR : "Evènement documenté" |
...
**Group 1**Mapping from [Modèle métier - Évènement documenté](StructureDefinition-Evenement.md) to `https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-documentation-of`
