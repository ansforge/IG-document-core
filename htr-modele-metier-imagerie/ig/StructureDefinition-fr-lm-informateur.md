...
| Draft as of 2025-10-21 | *Computable Name*:FRLMInformateur |
...
* Use this Logical Model: [Modèle logique métier - FR LM Acte](StructureDefinition-fr-lm-acte.md), [Modèle logique métier - FR LM En-tête document](StructureDefinition-fr-lm-entete-document.md) and [Modèle logique métier - FR LM Rencontre](StructureDefinition-fr-lm-rencontre.md)
