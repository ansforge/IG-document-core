...
| Draft as of 2026-01-05 | *Computable Name*:Mapping Métier/CDA/FHIR : "Utilisation de dispositif médical" |
...
```json
{
  ...
  "version" : "0.1.0",
  "name" : "Mapping Métier/CDA/FHIR : \"Utilisation de dispositif médical\"",
