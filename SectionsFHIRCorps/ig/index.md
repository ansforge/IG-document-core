...
| Draft as of 2026-01-16 | *Computable Name*:FRDocumentCore |
...
* [ParticipationType](http://terminology.hl7.org/7.0.1/CodeSystem-v3-ParticipationType.html): [FRActorExtension](StructureDefinition-fr-actor-extension.md), [FRCompositionDocument](StructureDefinition-fr-composition-document.md)...Show 5 more,[FRCompositionDocumentCRBIO](StructureDefinition-fr-composition-document-cr-bio.md),[FRObservationLaboratoryReportResultsDocument](StructureDefinition-fr-observation-laboratory-report-results-document.md),[FRObservationSurveyDocument](StructureDefinition-fr-observation-survey-document.md),[FRValueSetActorTypeDocument](ValueSet-fr-vs-actor-type-document.md)and[FRValueSetParticipationType](ValueSet-fr-doc-vs-participation-type.md)
...
```json
{
  ...
  "definition" : {
    ...
    "grouping" : [
      ...
      {
        "id" : "Modèles logiques métiers des composants élémentaires",
    ...
    "resource" : [
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/fr-composition-document-cr-bio"
        },
        "name" : "FR Composition Document CR BIO",
      ...
      },
      {
        ...
        "exampleBoolean" : false,
        "groupingId" : "Modèles logiques métiers des composants élémentaires"
      },
      {
        "extension" : [
          {
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/fr-vs-liste-sections"
        },
        "name" : "ValueSet – FR ValueSet Liste des sections",
