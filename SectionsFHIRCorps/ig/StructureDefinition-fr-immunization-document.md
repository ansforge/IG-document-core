...
| Draft as of 2026-01-16 | *Computable Name*:FRImmunizationDocument |
...
* Référer à ce Profil: [FR Composition Document CR BIO](StructureDefinition-fr-composition-document-cr-bio.md) and [ImmunizationRecommendation - FR Immunization Recommendation Document](StructureDefinition-fr-immunization-recommendation-document.md)
