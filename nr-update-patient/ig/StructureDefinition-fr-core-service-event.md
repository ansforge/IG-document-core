...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-service-event | *Version*:0.1.0 |
| Draft as of 2025-10-21 | *Computable Name*:FrServiceEvent |
...
* Use this Logical Model Profile: [CDA - documentationOf](StructureDefinition-fr-core-documentation-of.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-core-service-event)
...
Other representations of profile: [CSV](StructureDefinition-fr-core-service-event.csv), [Excel](StructureDefinition-fr-core-service-event.xlsx) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-service-event",
  "version" : "0.1.0",
  "name" : "FrServiceEvent",
        ...
        "constraint" : [
          {
            ...
            "source" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-service-event"
          }
        ]
      },
      {
        ...
        "type" : [
          {
            ...
            "profile" : [
              "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-performer"
            ]
          }
        ]
      },
