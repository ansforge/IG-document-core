...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-informant | *Version*:0.1.0 |
| Draft as of 2025-10-21 | *Computable Name*:FrInformant |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-core-informant)
...
Other representations of profile: [CSV](StructureDefinition-fr-core-informant.csv), [Excel](StructureDefinition-fr-core-informant.xlsx) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-informant",
  "version" : "0.1.0",
  "name" : "FrInformant",
  "title" : "CDA - informant",
  "status" : "draft",
        ...
        "type" : [
          {
            ...
            "profile" : [
              "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-core-related-entity"
            ]
          }
        ]
      }
