...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-device-document | *Version*:0.1.0 |
| Draft as of 2025-10-21 | *Computable Name*:FrDeviceDocument |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-device-document)
...
Other representations of profile: [CSV](StructureDefinition-fr-device-document.csv), [Excel](StructureDefinition-fr-device-document.xlsx), [Schematron](StructureDefinition-fr-device-document.sch) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-device-document",
  "version" : "0.1.0",
  "name" : "FrDeviceDocument",
